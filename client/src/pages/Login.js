...
function Login() {
    ...
    const onSubmit = async (data) => {
        try {
            const response = await http.post('/api/authentication/login', data);
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='login-forgot-base'>
                                <label htmlFor="rememberMe" className='login-forgot-label'>
                                    <span>
                                        <input type="checkbox" id="rememberMe" className='login-checkbox' {...register('rememberMe')} />
