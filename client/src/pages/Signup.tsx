                ...
                <label htmlFor="rememberMe" className='login-forgot-label'>
                  <span>
                    <input
                      ...
                      {...register('rememberMe', {required: 'Please select'})}
                    />
                  ...
                  <a href="/forgot-password">privacy policy & terms</a>
                </label>
